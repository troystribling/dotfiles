...
var RichestMime = function (_React$Component) {
  ...
  _createClass(RichestMime, [{
    ...
    value: function render() {
      ...
      var Transform = this.props.transforms.get(mimetype);
      var data = this.props.bundle.get(mimetype);
      var metadata = this.props.metadata.get(mimetype);
...
RichestMime.defaultProps = {
  ...
  theme: "light",
  metadata: new _immutable.Map(),
  bundle: new _immutable.Map(),
