...
declare class atom$TextEditorRegistry {
  ...
  observe(callback: (editor: atom$TextEditor) => mixed): IDisposable,
...
declare class atom$TextEditor extends atom$Model {
  ...
  // This is undocumented, but Atom-IDE uses it in the AtomTextEditor wrapper.
...
type atom$DestroyPaneItemEvent = {
  item: atom$PaneItem,
  pane: atom$Pane,
  index: number,
};

type atom$AddPaneItemEvent = {
  item: atom$PaneItem,
  pane: atom$Pane,
  index: number,
};

type atom$OnDidOpenEvent = {
  uri: string,
  item: mixed,
  pane: atom$Pane,
  index: number,
...
declare class atom$Workspace {
  ...
  onDidAddTextEditor(callback: (event: atom$AddTextEditorEvent) => mixed): IDisposable,
  onDidChangeActivePaneItem(callback: (item: mixed) => mixed): IDisposable,
  onDidDestroyPaneItem(callback: (event: atom$DestroyPaneItemEvent) => mixed): IDisposable,
  onDidAddPaneItem(callback: (event: atom$AddPaneItemEvent) => mixed): IDisposable,
  ...
  onDidOpen(callback: (event: atom$OnDidOpenEvent) => mixed): IDisposable,
...
type atom$DidChangeTextEvent = {
  changes: Array<atom$TextEditEvent>,
};

type atom$DidStopChangingEvent = {
  changes: Array<atom$TextEditEvent>,
};
...
declare class atom$TextBuffer {
  ...
  onDidChangeText(callback: (event: atom$DidChangeTextEvent) => void): IDisposable,
  onDidStopChanging(callback: (event: atom$DidStopChangingEvent) => mixed): IDisposable,
