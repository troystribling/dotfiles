(function (factory) {
    ...
    var JSONDocumentSymbols = (function () {
        ...
        JSONDocumentSymbols.prototype.getColorPresentations = function (document, doc, colorInfo) {
            var result = [];
            ...
            result.push({ label: label, textEdit: vscode_languageserver_types_1.TextEdit.replace(colorInfo.range, JSON.stringify(label)) });
            return result;
        };
