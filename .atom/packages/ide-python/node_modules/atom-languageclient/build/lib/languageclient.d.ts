...
export declare class LanguageClientConnection extends EventEmitter {
    ...
    documentSymbol(params: lsp.DocumentSymbolParams, cancellationToken?: jsonrpc.CancellationToken): Promise<lsp.SymbolInformation[]>;
    workspaceSymbol(params: lsp.WorkspaceSymbolParams): Promise<lsp.SymbolInformation[]>;
    codeAction(params: lsp.CodeActionParams): Promise<lsp.Command[]>;
    ...
    private _onRequest(type, callback);
    private _onNotification(type, callback);
    private _sendNotification(method, args?);
    private _sendRequest(method, args?, cancellationToken?);
}
