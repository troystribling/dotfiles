...
figure, axis = pyplot.subplots(3, sharex=True, sharey=True, figsize=(12, 8))
axis[0].set_title("AR(1) Time Series")
...
for i in range(0, len(αs)):
    ...
    axis[i].plot(range(0, len(samples)), samples, color="#000000", lw="2", zorder=10)
