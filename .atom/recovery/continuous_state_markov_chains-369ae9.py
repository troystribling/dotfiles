...
colors = ["#C7011A", "#EDD914", "#14ED1B", "#00bfff"]
...
figure, axis = pyplot.subplots(figsize=(12, 5))
axis.set_xlabel("y", fontsize=15)
axis.set_ylabel(r'$\pi$', fontsize=15)
...
axis.text(-5.9, 0.125, f"Total Time Steps={nsamples}\nα={α}\nσ={σ}", fontsize=15, bbox=dict(facecolor='white', alpha=0.7))
axis.legend(bbox_to_anchor=(0.24, 1.0), fontsize=15)
