...
axis.set_title(f"AR(1) Relaxation to Equilibrium, {nsamples} Time Steps")
axis.set_ylim([0, 0.5])
axis.grid(True, zorder=5)
...
for i in range(0, len(steps)):
    axis.plot(y, kernel_mean[steps[i]], color="#A60628", lw="3", zorder=10, alpha=alpha[i])
...
axis.plot(y, kernel_mean[-1], color="#000000", lw="3", zorder=10)
