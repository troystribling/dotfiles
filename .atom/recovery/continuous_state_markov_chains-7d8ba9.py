...
axis.text(-5.7, 0.125, f"Total Time Steps={nsamples}\nα={α}\nσ={σ}", fontsize=14, bbox=dict(facecolor='white', alpha=0.7, edgecolor="grey", linewidth=1.0))
axis.legend(bbox_to_anchor=(0.24, 1.0), fontsize=14)
