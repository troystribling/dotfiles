...
def sample_plot(samples, sampled_function):
    ...
    sample_distribution = [sampled_function(val) for val in numpy.arange(bins[0], bins[1], delat)]
    axis.plot(bins, sample_distribution, color="#A60628", label=f"Sampled Function", lw="3", zorder=10)
